...
public class InputHandler : MonoBehaviour
{
  ...
  private IEnumerator Move(Vector2 direction)
  {
    ...
    // Wait for a slightly longer duration to ensure that the player can't move until the movement has completely finished.
    yield return new WaitForSeconds(moveDuration + 0.07f);
